...
function App() {
  ...
  const calculateTIA = useCallback(() => {
    ...
    // Scale T-TESS (1-5) to 50 points
    const weightedTTess = (ttessAvg / 5) * 50;
    // Scale Growth (0-100) to 50 points
    ...
    const overallEligible = meetsTTessThreshold && meetsGrowthThreshold;

    // 5. Designation Level
    let designation = DesignationLevel.NONE;
    if (overallEligible) {
      if (totalPoints >= 80) designation = DesignationLevel.MASTER;
      else if (totalPoints >= 69) designation = DesignationLevel.EXEMPLARY;
      else if (totalPoints >= 64.5) designation = DesignationLevel.RECOGNIZED;
    }
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <span className="text-gray-600">80 - 100 pts</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="font-bold text-blue-600">Exemplary</span>
                      <span className="text-gray-600">69 - 79.9 pts</span>
                    </div>
                    <div className="flex justify-between items-center text-xs">
                      <span className="font-bold text-indigo-500">Recognized</span>
                      <span className="text-gray-600">64.5 - 68.9 pts</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <div className="flex justify-between items-start text-xs">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-r2-red italic font-medium">Minimum score of 3.7 required</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-start text-xs pt-1">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-r2-red italic font-medium">Minimum score of 55% required</span>
                      </div>
                    </div>
                  </div>
                </div>
